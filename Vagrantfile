...
Vagrant.configure("2") do |config|
  config.vm.define "controller" do |controller|
    ...
    controller.vm.network :hostonly, ip: "10.0.0.11", :adapter => 2
    #controller.vm.network :forwarded_port, guest: 22, host: 10122, id: "ssh"
	controller.vm.network :hostonly, ip: "192.168.100.11", :adapter => 3
  ...
  config.vm.define "compute" do |compute|
    ...
    compute.vm.network :hostonly, ip: "10.0.0.31"
    #compute.vm.network :forwarded_port, guest: 22, host: 10222, id: "ssh"
	 compute.vm.network :hostonly, ip: "192.168.100.31", :adapter => 3
  ...
  config.vm.define "block1" do |block1|
    ...
    block1.vm.network :hostonly, ip: "10.0.0.51"
    #block1.vm.network :forwarded_port, guest: 22, host: 10222, id: "ssh"
	block1.vm.network :hostonly, ip: "192.168.100.51", :adapter => 3
   ...
   config.vm.define "object1" do |object1|
    ...
    object1.vm.network :hostonly, ip: "10.0.0.71"
    #object1.vm.network :forwarded_port, guest: 22, host: 10222, id: "ssh"
	object1.vm.network :hostonly, ip: "192.168.100.71", :adapter => 3
  ...
  config.vm.define "object2" do |object2|
    ...
    object2.vm.network :hostonly, ip: "10.0.0.72"
    #object2.vm.network :forwarded_port, guest: 22, host: 10222, id: "ssh"
	object2.vm.network :hostonly, ip: "192.168.100.72", :adapter => 3
